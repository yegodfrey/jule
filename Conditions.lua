...
local function RefreshConditionSet(set)
	local _, instanceType, _, _, _, _, instanceID = GetInstanceInfo();
	local uiMapID

	if instanceType ~= "party" and instanceType ~= "raid" and instanceType ~= "arena" and instanceType ~= "pvp" then
		instanceType = "none"
...
function BtWLoadoutsConditionsMixin:Update()
	...
	sidebar:SetSupportedFilters("spec", "class", "role", "character", "instanceType", "instance",  "disabled")
